...
{
	G_OBJECT_CLASS (klass)->get_property = cell_item_get_property;
	G_OBJECT_CLASS (klass)->set_property = cell_item_set_property;
	G_OBJECT_CLASS (klass)->dispose = cell_item_dispose;
	G_OBJECT_CLASS (klass)->finalize = cell_item_finalize;
...
{
	CellItem *item = g_object_new (CELL_TYPE_ITEM, NULL);
