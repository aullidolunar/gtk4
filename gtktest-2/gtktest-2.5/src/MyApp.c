...
// action entries:
	const GActionEntry entries[] =
    {
        ...
        {"borra", cb_borra, NULL, NULL, NULL, { 0, 0, 0 }},
    ...
    gtk_application_set_accels_for_action (GTK_APPLICATION (app), "app.borra", borra);
...
// UI:
	...
	g_menu_append (menu_sec2, "B_orrar", "app.borra");
...
void my_app_dispose (GObject* obj)
{
	...
	g_slice_free (AppData, MY_APP (obj)->data);
...
MyApp *my_app_new ()
{
	MyApp* obj = g_object_new (MY_TYPE_APP, "application-id", PROJECT_APPID, "flags", G_APPLICATION_DEFAULT_FLAGS, NULL);
	obj->data = g_slice_new0 (AppData);
	return obj;
}
