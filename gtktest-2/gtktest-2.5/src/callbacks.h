...
void cb_edita (GSimpleAction *, GVariant *, gpointer);
void cb_borra (GSimpleAction *, GVariant *, gpointer);
void cb_clean (GSimpleAction *, GVariant *, gpointer);
...
void cb_ok_clicked2 (GtkButton*, gpointer);
